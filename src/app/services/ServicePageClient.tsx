...
const serviceCards: ServiceCardData[] = [
  {
    ...
    gradientVia: "via-[#111111]/20 group-hover:via-[#111111]/60",
    iconBg: "bg-[#111111]/8 group-hover:bg-[#111111]/12",
    iconColor: "text-[#111111]",
    tagHoverColor: "group-hover:text-[#111111]",
    icon: Terminal,
  },
  {
    telemetry: "02 // AI",
    ...
    gradientVia: "via-[#c4923a]/20 group-hover:via-[#c4923a]/60",
    iconBg: "bg-[#c4923a]/8 group-hover:bg-[#c4923a]/15",
    iconColor: "text-[#b8860b]",
    tagHoverColor: "group-hover:text-[#b8860b]",
    icon: Brain,
  },
  {
    telemetry: "03 // AUTO",
    ...
    gradientVia: "via-[#8b6914]/20 group-hover:via-[#8b6914]/60",
    iconBg: "bg-[#8b6914]/8 group-hover:bg-[#8b6914]/15",
    iconColor: "text-[#8b6914]",
    tagHoverColor: "group-hover:text-[#8b6914]",
    icon: Workflow,
  },
  {
    telemetry: "04 // WEB",
    ...
    gradientVia: "via-[#c4923a]/20 group-hover:via-[#c4923a]/50",
    iconBg: "bg-[#c4923a]/10 group-hover:bg-[#c4923a]/20",
    iconColor: "text-[#c4923a]",
    tagHoverColor: "group-hover:text-[#c4923a]",
    icon: Globe,
  },
  {
    telemetry: "05 // APP",
    ...
    gradientVia: "via-[#111111]/20 group-hover:via-[#111111]/50",
    iconBg: "bg-[#111111]/6 group-hover:bg-[#111111]/10",
    iconColor: "text-[#111111]",
    tagHoverColor: "group-hover:text-[#111111]",
    icon: Smartphone,
  },
...
const techStack = [
  {
    ...
    icon: (
      <svg
        className="h-8 w-8 text-[#111111] transition-transform group-hover:scale-110"
        fill="none"
        viewBox="0 0 180 180"
      >
        <mask
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-8 w-8 text-cyan-600 transition-transform group-hover:scale-110"
        fill="currentColor"
  ...
  },
  {
    ...
    icon: (
      <div className="font-mono text-xl font-bold text-blue-700 transition-transform group-hover:scale-110">
        TS
      </div>
    ),
  },
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-8 w-8 text-[#b8860b] transition-transform group-hover:scale-110"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
  ...
  },
  {
    ...
    url: "https://gsap.com",
    icon: (
      <div className="font-mono text-lg font-bold tracking-tight text-emerald-700 transition-transform group-hover:scale-110">
        GSAP
      </div>
    ),
  },
  {
    ...
    icon: (
      <svg
        className="h-8 w-8 text-amber-600 transition-transform group-hover:scale-110"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-8 w-8 text-pink-600 transition-transform group-hover:scale-110"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
...
export function ServicePageClient() {
  return (
    <div className="relative flex w-full flex-col overflow-hidden pb-20 md:pb-8">
      {/* Subtle Gold Ambient Glow Orbs */}
      <div className="pointer-events-none absolute -top-40 left-1/2 h-[450px] w-[700px] -translate-x-1/2 rounded-full bg-[#c4923a]/10 blur-[140px]" />
      <div className="pointer-events-none absolute top-[35%] -left-48 h-[500px] w-[500px] rounded-full bg-[#b8860b]/8 blur-[150px]" />
      <div className="pointer-events-none absolute top-[70%] -right-48 h-[550px] w-[550px] rounded-full bg-[#c4923a]/8 blur-[160px]" />
      ...
      <section className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 pt-4 pb-16 text-center sm:px-12 sm:pt-6 sm:pb-20 lg:px-20">
        ...
        <motion.h1
          ...
          className="max-w-4xl text-4xl font-semibold tracking-tight text-[#111111] sm:text-5xl lg:text-[64px] lg:leading-[72px]"
        >
          Our{" "}
        ...
        <motion.p
          ...
          className="mt-4 max-w-2xl text-base leading-relaxed text-[#6b7280] sm:text-lg"
        >
        ...
        <motion.div
          ...
          className="mt-6 flex flex-wrap items-center justify-center gap-3 font-mono text-[13px] text-[#6b7280] sm:gap-4"
        >
          <span className="flex items-center gap-1.5">
            <BadgeCheck className="h-4 w-4 text-[#c4923a]" />
            Bespoke Engineering
          </span>
          <span className="text-[#9ca3af]/60">/</span>
          <span className="flex items-center gap-1.5">
            <Zap className="h-4 w-4 text-[#8b6914]" />
            Zero Vendor Lock-in
          </span>
          <span className="text-[#9ca3af]/60">/</span>
          <span className="flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {serviceCards.map((service, idx) => (
            <motion.div
              ...
              className="group relative flex flex-col justify-between rounded-xl border border-black/[0.08] bg-white/90 p-8 shadow-sm backdrop-blur-xl transition-all duration-300 hover:-translate-y-1.5 hover:border-[rgba(196,146,58,0.40)] hover:shadow-[0_12px_32px_-8px_rgba(196,146,58,0.20)] sm:p-10"
            >
              <div
              ...
              <div>
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <span
                    className={`font-mono text-[13px] text-[#9ca3af]/60 transition-colors ${service.tagHoverColor}`}
                  >
                    {service.telemetry}
                  </span>
                </div>
                <h2
                  className={`mb-2 text-2xl font-medium tracking-tight text-[#111111] transition-colors ${service.tagHoverColor}`}
                >
                  {service.title}
                </h2>
                <p className="mb-4 text-[15px] leading-relaxed text-[#6b7280]">
                  {service.description}
                </p>
              </div>
              <div className="border-t border-black/[0.06] pt-4 font-mono text-[13px] leading-relaxed text-[#9ca3af]">
                {service.tags}
              </div>
            </motion.div>
          ))}
      ...
      <section className="relative z-10 w-full border-y border-black/[0.06] bg-[#f5eed8]/50 py-24 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-6 sm:px-12 lg:px-20">
          {/* Section Header */}
          <div className="mb-16 flex max-w-3xl flex-col items-start">
            <div className="mb-4 inline-flex items-center gap-1.5 rounded-full border border-[#c4923a]/25 bg-[#c4923a]/8 px-3 py-1 text-xs font-medium uppercase tracking-wider text-[#8b6914]">
          ...
          <div className="relative grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
            {stages.map((stage, idx) => (
              <motion.div
                ...
                className="group flex flex-col justify-between rounded-xl border border-black/[0.08] bg-white/80 p-4 transition-colors hover:border-[#c4923a]/35"
              >
                <div>
                  <div className="mb-2 flex items-center justify-between font-mono text-[13px] font-bold text-[#c4923a] transition-colors group-hover:text-[#b8860b]">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-9">
          {techStack.map((tech, idx) => (
            <motion.a
              ...
              className="group flex flex-col items-center justify-center rounded-xl border border-black/[0.08] bg-white/80 p-4 transition-all duration-300 hover:border-[rgba(196,146,58,0.40)] hover:bg-white hover:shadow-sm"
            >
              <div className="mb-2 flex h-10 w-10 items-center justify-center">
                {tech.icon}
              </div>
              <span className="font-mono text-[13px] text-[#374151] transition-colors group-hover:text-[#c4923a]">
                {tech.name}
              </span>
            </motion.a>
          ))}
      ...
      <section className="relative z-10 w-full border-t border-black/[0.06] py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-12 lg:px-20">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12">
            {/* Left descriptor */}
            <div className="space-y-4 lg:col-span-5">
              <div className="inline-flex items-center gap-1.5 rounded-full border border-[#c4923a]/25 bg-[#c4923a]/8 px-3 py-1 text-xs font-medium uppercase tracking-wider text-[#8b6914]">
                WHY CHOOSE US
              </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:col-span-7">
              {metrics.map((metric, idx) => (
                <motion.div
                  ...
                  className="flex flex-col justify-between rounded-xl border border-black/[0.08] bg-white/90 p-6 shadow-sm sm:p-8"
                >
                  <div>
      ...
      <section className="relative z-10 w-full py-24" id="cta">
        <div className="mx-auto max-w-5xl px-6 sm:px-12">
          <motion.div
            ...
            className="relative flex flex-col items-center overflow-hidden rounded-2xl border border-[rgba(196,146,58,0.35)] bg-gradient-to-b from-[#fdf8ee] to-[#f5eed8]/60 p-10 text-center sm:p-16"
          >
            {/* Center atmospheric pulse */}
            <div className="pointer-events-none absolute -top-32 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-[#c4923a]/15 blur-3xl" />
            <h2 className="mb-4 text-3xl font-semibold tracking-tight text-[#111111] sm:text-4xl">
              Ready to Get Started?
            </h2>
            <p className="mb-10 max-w-xl text-base leading-relaxed text-[#6b7280] sm:text-lg">
              Let&apos;s discuss how we can help transform your digital presence and achieve your business goals.
            </p>
            <Link
              href="/contact"
              className="purple-glow-shadow relative inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#111111] via-[#1a1a1a] to-[#111111] px-10 py-3.5 text-xs font-semibold uppercase tracking-wider text-white transition-all duration-300 hover:scale-105 hover:from-[#0a0a0a] hover:to-[#333333] active:scale-95"
            >
              Get in Touch
